...
class TestRateLimited(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_wrapper_called_once(self):
        ...
        # Act
        result = await rate_limited(**kwargs)(mockedCoroutine)(*coroutineArgs, **coroutineKwargs)
    ...
    async def test_wrapper_called_multiple(self):
        ...
        # Act
        result1 = await rate_limited(**kwargs)(mockedCoroutine)(*coroutineArgs1, **coroutineKwargs1)
        result2 = await rate_limited(**kwargs)(mockedCoroutine)(*coroutineArgs2, **coroutineKwargs2)
